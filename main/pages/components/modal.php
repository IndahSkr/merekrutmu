...
<!-- Tambah Loker -->
<div class="modal fade mdModal" id="modalILoker" data-coreui-backdrop="static" data-coreui-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="emodalILokerModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header" style="padding: 0.5rem 1rem">
        ...
        <div class="modal-body" style="padding-top: 0; padding-bottom: 0.5rem">
          <div class="row">
            <div class="col-12 col-xl-6 mb-12 mb-xl-12">
              <div class="row" style="border: 1px black solid; padding: 10px; border-radius: 10px; margin-bottom: 10px; margin-top: 10px">
                <div class="col-12 row">
                  <div class="col-md-6 col-sm-12" style="padding-top: 10px">
                    <h6 class="font-weight-bold">Tanggal Buka</h6>
                    <div class="form-group" style="margin-bottom: 0">
